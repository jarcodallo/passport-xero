...
This has been modified (the createClient method, specifically) to read in a key and secret for Xero authentication. The existing modules provide no way to pass this information down, so this hard coded customization was necessary. 
